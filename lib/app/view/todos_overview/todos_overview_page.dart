...
import 'package:flutter_todos/app/view/todos_overview/widgets.dart';
        ...
        child: BlocBuilder<TodosOverviewBloc, TodosOverviewState>(
          builder: (context, state) {
            ...
            return CupertinoScrollbar(
                child: ListView(
              children: [
                for (final Todo todo in state.filteredTodos)
                  TodoListTile(
                    todo: todo,
                    onToggleCompleted: () =>
                        context.read<TodosOverviewBloc>().add(
                              TodosOverviewTodoCompletionToggled(todo: todo),
                            ),
                    onDismissed: () => context.read<TodosOverviewBloc>().add(
