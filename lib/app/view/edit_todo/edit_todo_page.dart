...
import 'package:flutter_todos/app/view/edit_todo/bloc/edit_todo_bloc.dart';
  ...
  Widget build(BuildContext context) {
    return BlocListener<EditTodoBloc, EditTodoState>(
      listenWhen: (previous, current) =>
          previous.editTodoStatus != current.editTodoStatus &&
          current.editTodoStatus == EditTodoStatus.success,
...
class EditTodoView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final status = context.select(
      (EditTodoBloc bloc) => bloc.state.editTodoStatus,
    );
  ...
  Widget build(BuildContext context) {
    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
        enabled: !state.editTodoStatus.isLoadingOrSuccess,
